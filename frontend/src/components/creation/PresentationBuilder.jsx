...
import {
    FiSave, FiArrowLeft, FiPlus, FiMonitor, FiType, FiImage, FiGrid, FiUsers, FiPlay, FiStopCircle,
    FiArrowRight, FiArrowLeft as FiArrowLeftIcon, FiMaximize2, FiChevronDown, FiPlusSquare,
